...
// CheckOut .
// @router /api/ddd/demo/parking/check_out [POST]
func CheckOut(ctx context.Context, c *hertz_app.RequestContext) {
	var err error
	var req ddd_demo_parking.CheckOutRequest
	err = binding.BindAndValidate(c, &req)
	if err != nil {
		c.String(400, err.Error())
		return
	}
	resp := app.GetParkingApp().CheckOut(ctx, &req)
